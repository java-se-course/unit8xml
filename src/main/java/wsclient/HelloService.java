 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://se.java.course.epam.com/", wsdlLocation = "http://127.0.0.1:1212/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://se.java.course.epam.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:1212/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://se.java.course.epam.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://se.java.course.epam.com/", "HelloPort"), Hello.class, features);
    }
